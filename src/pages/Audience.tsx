...
export const Audience = () => {
    ...
    const audiences: Array<Audience> = [
        {id: 1, title: "Customers with more than ₹10K Orders", numUsers: 65, createdAt: Date.now()},
        {id: 2, title: "Customers with less than ₹10K Orders", numUsers: 24, createdAt: Date.now()},
        {id: 3, title: "Customers with no visits in last 3 months", numUsers: 984, createdAt: Date.now()},
        {id: 4, title: "Customers with 3 visits and total amount less than ₹10K", numUsers: 420, createdAt: Date.now()},
    ];
                ...
                <div className='flex flex-col'>
                    ...
                    <div className="space-y-4">
                        {audiences.map((audience) => {
                            return (
                                <div key={audience.id} className="p-4 bg-white border rounded-xl text-gray-800 space-y-2 text-left">
                                    ...
                                    <a href="javascript:void(0)" className="font-bold hover:text-yellow-800 hover:underline">{audience.title}</a>
